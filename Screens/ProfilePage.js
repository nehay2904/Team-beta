    ...
    <ScrollView>
      ...
      <View style={styles.maincontainer}>
        ...
        navigation.navigate('ProfileUpdateScreen', { name: 'cancel' })
          ...
          <Text style={styles.profilebio}>When password,  will check if the password you entered is considered weak according to datasets like HaveIBeenPwned. The password may be</Text>
