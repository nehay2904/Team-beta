    ...
    <ScrollView>
      ...
      <View style={styles.maincontainer}>
        <View style={styles.container}>
          ...
          <Text style={styles.profilebio}>Whene n account, or change your password, npm will check if the password you entered is considered weak according to datasets like HaveIBeenPwned. The password may be</Text>
