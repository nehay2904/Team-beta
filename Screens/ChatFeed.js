  ...
  return (
    <View style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <View style={styles.external}>
        <ScrollView style={styles.internal}>
          <View style={styles.chatBody}>
            ...
            <View style={styles.chatReciever}>
              <Text style={{ color: 'white' }}>heyyyaaa how are you doin?heyyyaaa how are you doin?heyyyaaa how are you doin?heyyyaaa how are you doin?heyyyaaa how are you doin?</Text>
            </View>
          </View>
